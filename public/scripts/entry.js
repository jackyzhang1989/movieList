...
var MovieBox = React.createClass({
  ...
  actionFormatter: function(cell, row){
	return (<DeleteBtn cell={cell} data={this.state.data} functor={this.deleteEle}/>);
  },  
...
var DeleteBtn = React.createClass({
  ...
  render: function() {
    return (
		<a className="pointer" onClick={this.handleClick.bind(this, this.props.cell, this.props.functor)}><i className="material-icons">delete_forever</i>Delete</a>
    );
  }	  
});	  
function draw(){
...
var url;
ReactDOM.render(
  <MovieBox url="/api/movies" pollInterval={6000} />,
